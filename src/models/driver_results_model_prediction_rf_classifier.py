...
# MAGIC %md
# MAGIC Logistic Regression Model (Classifier)
...
vecAssembler = VectorAssembler(inputCols = ['resultId', 'raceYear','gridPosition','fastestLapRank','driverStPosition'
                                            , 'driverSeasonWins',
                                            'constSeasonPoints', 'constSeasonWins', 'finishPositionRM1','finishPositionRM2',
                                            'finishPositionRM3'
